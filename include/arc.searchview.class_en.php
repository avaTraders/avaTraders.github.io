...
$this->dtp->Assign($tagid,lib_sql($ctag,$this));
    ...
    $imgwidth=120,$imgheight=90,$achanneltype="all",$orderby="default",$innertext="",$tablewidth="100")
    {
        ...
        if ($cfg_sphinx_article == 'Y')
        {
            ...
            where  act.id not in (1,2,35,36) and {$this->AddSql} $ordersql limit $limitstart,$row";
        }
    ...
    function GetPageListDM($list_len)
    {
        ...
        {
            return "Found 1 Page /".$this->TotalResult." Records. ";
        }
        if($this->TotalResult == 0)
        {
            return "Found 0 Page /".$this->TotalResult." Records. ";
        }
        $purl = $this->GetCurUrl();
        ...
        $infos = "<td>Found<b>".$this->TotalResult."</b> Records. /Max<b>{$totalpage}</b> Page  </td>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<td width='120'><a href='".$purl."PageNo=$totalpage'> Last Page </a></td>\r\n";
        }
        else
        {
            $endpage="<td width='120'> Last Page </td>\r\n";
        }
